...
def train(isTrain=True):
    train_steps = 100
    checkpoint_steps = 50
    checkpoint_dir = os.getcwd() + '/tmp/tfsaver2/'
    ...
    with tf.Session() as sess:
        if isTrain:
            ...
            summary_dir = os.getcwd() + '/tmp/tfsaver2_summary/'
            ...
            new_saver = tf.train.import_meta_graph(checkpoint_dir + 'model.ckpt-100.meta')
